...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, CODE,       LOWER, KC_BSPC, KC_LSFT,     KC_RSFT, KC_SPC, RAISE,       HACK,    KC_DOWN, KC_UP,   KC_LCTL
  ),
   ...
   * |  ~   |   !  |   @  |   {  |   }  |   -  |      |                    |      |   =  | Home | End  |   (  |   )  |  |   |
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * | Tab  |   1  |   2  |   (  |   )  |   5  |      |                    |      | Left | Enter|  Up  | Right|   :  |  "   |
   * |------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------+------|
   * | Shift|   6  |   7  |   [  |   ]  |   {  |      |             |      |      |   }  |PageUp|PageDn|  End |   ?  | Shift|
   * |-------------+------+------+------+------+  Del +------+------+------+ Space+------+------+------+------+-------------|
  ...
  [_RAISE] = LAYOUT(
    ...
    KC_TILD, KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_MINS, _______,                        _______, KC_EQL,  KC_HOME, KC_END,  KC_LPRN, KC_RPRN, KC_PIPE,
    KC_TAB,  KC_1,    KC_2,    KC_LPRN, KC_RPRN, KC_5,    _______,                        _______, KC_LEFT, KC_ENT,  KC_UP,   KC_RGHT, KC_COLN, KC_DQT ,
    KC_LSFT, KC_6,    KC_7,    KC_LBRC, KC_RBRC, KC_LCBR, _______,                        _______, KC_RCBR, KC_PGUP, KC_PGDN, KC_END,  KC_QUES, KC_RSFT,
    KC_LCTL, KC_LGUI, KC_LALT, CODE,             LOWER,   KC_DEL,  KC_LSFT,      KC_RSFT,  KC_SPC, RAISE,            HACK,    KC_PGDN, KC_PGUP, KC_END
  ),
   ...
   * |  ~   |   !  |   @  |   #  |   $  |   _  |       |                    |      |   +  |   &  |   *  |   (  |   )  |  |   |
   * |------+------+------+------+------+------+-------+--------------------+------+------+------+------+------+------+------|
   * | Tab  |   1  |   2  |   3  |  Tab |   [  |       |                    |      | Left | Down |  Up  | Right|   :  |  "   |
   * |------+------+------+------+------+------+----------------------------+------+------+------+------+------+------+------|
  ...
  [_LOWER] = LAYOUT(
    KC_F11,  KC_F1,   KC_F2,   KC_F3,   KC_F4,  KC_F5,   _______,                        _______, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F12,
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR, KC_UNDS, _______,                        _______, KC_PLUS, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_PIPE,
    KC_TAB,  KC_1,    KC_2,    KC_3,    KC_TAB, KC_LBRC, _______,                        _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,    KC_COLN, KC_DQT ,
    KC_LSFT, KC_6,    KC_7,    KC_8,    KC_9,   KC_LBRC, _______,                        _______, KC_RBRC, KC_M,    KC_LT,   KC_GT,   KC_QUES, KC_RSFT,
    KC_LCTL, KC_LGUI, KC_LALT, CODE,            LOWER,   KC_DEL,  KC_LSFT,      KC_RSFT, KC_BSPC, RAISE,            HACK,    KC_PGDN, KC_PGUP, KC_END
  ),
  ...
  // Adjust is kind of an annoying chord so we're using Hack layer for some of them.
  [_HACK] = LAYOUT(
    _______, _______, _______, _______, _______, _______,_______,                       _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______,_______,                       _______, _______, _______, _______, _______, KC_MPLY, _______,
    _______, _______, _______, _______, _______, _______,_______,                       _______, _______, KC_VOLD, KC_VOLU, _______, _______, _______,
    _______, _______, _______, _______, _______, _______,_______,                       _______, _______, KC_MUTE, KC_MPRV, KC_MNXT, _______, _______,
    _______, _______, _______, _______,          _______,_______,_______,       _______,_______, _______,          _______, _______, _______, _______
  )
};
