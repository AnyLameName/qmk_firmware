...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  |      |  ESC        | Space|      |   N  |   M  |   ,  |   .  |   /  | Shift|
   * |-------------+------+------+------+------+-Enter+------+------+------+ Space+------+------+------+------+-------------|
   * | Ctrl |  GUI |  ALt | Code |||||||| Lower|      |  Del |||||||| Bksp |      | Raise|||||||| Left | Down |  Up  | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,            KC_ESC,         KC_A           , KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
    KC_LCTL, KC_LGUI, KC_LALT, CODE,             LOWER,   KC_ENT ,KC_DEL,         KC_BSPC,KC_SPC , RAISE,            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
  ),
